...
export default function SkillOrganizationsPage() {
  ...
  useEffect(() => {
    ...
    api.get(`/catalog/categories/${category}/skills/${skill}/organizations`)
      .then(res => {
  ...
  return (
    <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8 fade-in">
      ...
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 tracking-tight">{skillName} firmalari</h1>
        <p className="text-gray-500 mt-2">Bu yo'nalish bo'yicha barcha mutaxassis tashkilotlar ro'yxati</p>
      </div>
      ...
      {loading ? (
        ...
        <OrganizationList 
          ...
          emptyMessage="Bu xizmat bo'yicha hozircha firmalar ro'yxatdan o'tmagan." 
        />
      )}
    </div>
  )
